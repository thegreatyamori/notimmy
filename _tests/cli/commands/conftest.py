...
def fake_run_command(mocker):
    ...
    mocks.run_fetch_live_offers = mocker.patch('src.business_logic.services.SchedulerService.run_fetch_live_offers')
    mocks.run_process_live_offers = mocker.patch('src.business_logic.services.SchedulerService.run_process_live_offers')
